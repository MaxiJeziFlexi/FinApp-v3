...
const OnboardingForm = ({ formData, setFormData, formErrors, consents, setConsents, incomeOptions, savingsOptions, loading, handleOnboardingSubmit, COLORS }) => (
  <Paper
    elevation={3}
    sx={{
      p: 4,
              ...
              {[
                ...
                <Button
                  ...
                  sx={{
                    ...
                    '&:hover': {
                      backgroundColor: formData.goal === goal.value ? COLORS.secondary : 'rgba(0, 168, 150, 0.1)'
                    }
                  }}
                >
              ...
              {[
                ...
                <Button
                  ...
                  sx={{
                    ...
                    backgroundColor: formData.timeframe === timeframe.value ? 'rgba(0, 168, 150, 0.1)' : 'white',
                    borderColor: formData.timeframe === timeframe.value ? COLORS.secondary : '#e0e0e0',
